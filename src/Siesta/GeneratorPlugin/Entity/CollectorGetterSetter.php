...
class CollectorGetterSetter extends BasePlugin
{
    ...
    public function generate(Entity $entity, ClassGenerator $classGenerator): void
    {
        ...
        foreach ($this->entity->getCollectionList() as $collection) {
            ...
            $this->generateCollectionSetter($collection);
     ...
     * @param Collection $collection
     */
    protected function generateCollectionSetter(Collection $collection): void
    {
        $methodName = 'set' . $collection->getMethodName();
        $name = $collection->getName();
        $foreignEntity = $collection->getForeignEntity();
        ...
        $method->addParameter($foreignEntity->getInstantiationClassName() . '[]', $name, null, null, true);
