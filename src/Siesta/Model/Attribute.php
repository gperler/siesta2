...
class Attribute
{
    ...
    public function getEnumValues(): array
    {
        ...
        $enumString = preg_replace("/^enum\(/i", '', $this->getDbType());
        $enumString = preg_replace("/\)$/", '', $enumString);
     ...
     * @return string|null
     */
    public function getEnumClassNameShort(): ?string
    {
        if (!$this->isEnum()) {
            return null;
        }
        return $this->entity->getClassShortName() . ucfirst($this->getPhpName());
    }
    ...
    public function getEnumClassName(): ?string
    {
        ...
        return $this->entity->getNamespaceName() . '\\' . $this->getEnumClassNameShort();
    }
     ...
     * @return string|null
     */
    public function getDbDefaultValue(): ?string
    {
        return $this->dbDefaultValue;
    }

    /**
     * @param string|null $dbDefaultValue
     * @return void
     */
    public function setDbDefaultValue(?string $dbDefaultValue): void
    {
    ...
    public function implementsArraySerializable(): bool
    {
        ...
        return $reflect->implementsInterface(ArraySerializable::class);
    }
