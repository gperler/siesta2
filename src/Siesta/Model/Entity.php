...
class Entity
{
     ...
     * @return string|null
     */
    public function getTransferClassShortName(): ?string
    {
        if ($this->constructor !== null) {
            return $this->constructor->getClassShortName() . 'Transfer';
        }
        return $this->classShortName . 'Transfer';
    }
    ...
    {
        return $this->getNamespaceName() . "\\" . $this->getTransferClassShortName();
    }
