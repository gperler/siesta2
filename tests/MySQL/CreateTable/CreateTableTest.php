...
class CreateTableTest extends Unit
{
    ...
    public function testAttributeCreate()
    {
        ...
        $expected = "CREATE TABLE IF NOT EXISTS `Artist` (`id` INT NOT NULL, `smallint` SMALLINT NULL, `int` INT NOT NULL DEFAULT 4, `string` VARCHAR(100) NOT NULL, `datetime` DATETIME NULL, `date` DATE NULL, `time` TIME NULL, PRIMARY KEY (`id`,`string`))";
